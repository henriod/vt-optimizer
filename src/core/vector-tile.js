...
Tile.Value._readField = function (tag, obj, pbf) {
	...
	if (tag === 1) {
		...
		obj.int_value = pbf.readVarint(true);
...
Tile.Value.write = function (obj, pbf) {
	...
	if (obj.int_value) {
		...
		pbf.writeVarintField(4, obj.int_value);
	...
	if (obj.sint_value) {
		...
		pbf.writeSVarintField(6, obj.sint_value);

	}
	if (obj.bool_value) {

		pbf.writeBooleanField(7, obj.bool_value);
...
Tile.Feature._readField = function (tag, obj, pbf) {
	...
	if (tag === 1) {
		...
		pbf.readPackedVarint(obj.geometry);
